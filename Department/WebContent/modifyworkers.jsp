...
<head>
	...
	<div>
		...
		<!-- 修改员工页面 -->
		<div class="container">
			<form method="post" action="/Department/modifyWorkersServlet">
			  <div class="form-group">
			    <label for="exampleInputEmail1">员工名称：</label>
			    <input type="text" class="form-control" name="wname" placeholder="请输入新的员工名称">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">员工年龄：</label>
			    <input type="text" class="form-control" name="wage" placeholder="请输入新的员工年龄">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">员工性别：</label>
			    <input type="text" class="form-control" name="wsex" placeholder="请输入新的员工性别">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">联系电话：</label>
			    <input type="text" class="form-control" name="wtel" placeholder="请输入新的员工的联系电话">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">薪资：</label>
			    <input type="text" class="form-control" name="wsalary" placeholder="请输入新的员工的联系电话">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">所属部门：</label>
			    <input type="text" class="form-control" name="dept" placeholder="请输入员工新的的所属部门">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">员工编号：</label>
			    <input type="text" class="form-control" name="yid" placeholder="请输入需要修改的员工的编码">
			  </div>
			  <div>
			  	<input onclick = 'fun()' type="submit" value="修改员工" class="btn btn-info"/>
			  </div>
			</form>
		</div>
		<script type="text/javascript">
			function fun(){
				//给出弹窗，添加成功
				alert("修改成功！");
				//跳转到workers.jsp界面，可以查看数据是否已经添加
// 				window.open("/Department/workers.jsp");
			}
			function fun1(){
				//返回到前一次浏览的页面
				history.back(-1);

...
<head>
	...
	<body>
		...
		<!-- 设置值日人员界面 -->
		<div class="container">
			<form method="post" action="/Department/OndutyServlet">
			  <div class="form-group">
			    <label for="exampleInputEmail1">部门名称：</label>
			    <input type="text" class="form-control" name="dept" placeholder="请输入部门名称">
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    <label for="exampleInputEmail1">值日时间：</label>
			    <input type="text" class="form-control" name="O_time" placeholder="请输入值日时间">
			  </div>
<!-- 			  <div class="form-group"> -->
...
<!-- 			  </div> -->
			  <div>
			  	<input onclick = 'fun()' type="submit" value="添加值日人员" class="btn btn-info"/>
			  </div>
			</form>
		</div>
		...
		<script type="text/javascript">
			function fun(){
				...
				//window.open("/Department/OnDuty.jsp");
			}
			function fun1(){
				//返回到前一次浏览的页面
				history.back(-1);

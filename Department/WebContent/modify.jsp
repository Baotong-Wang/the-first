...
<head>
	...
	<body>
		...
		<!-- 修改部门页面 -->
		<div class="container">
			<form method="post" action="/Department/modifySetvlet">
			  <div class="form-group">
			    <label for="exampleInputEmail1">部门名称：</label>
			    <input type="text" class="form-control" name="dname" placeholder="请输入新的部门名称">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">部门人数：</label>
			    <input type="text" class="form-control" name="dnumber" placeholder="请输入新的部门人数">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">负责人：</label>
			    <input type="text" class="form-control" name="director" placeholder="请输入新的负责人姓名">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">工作地点：</label>
			    <input type="text" class="form-control" name="dlocation" placeholder="请输入新的工作地点">
			  </div>
			   <div class="form-group">
			  ...
			  <div>
			  	<input class="btn btn-info" type="submit" onclick = 'fun()' value="修改部门" />
			  </div>
			</form>
		</div>
		...
		<script type="text/javascript">
			function fun(){
				...
				//window.location.href = "/Department/select.jsp";
